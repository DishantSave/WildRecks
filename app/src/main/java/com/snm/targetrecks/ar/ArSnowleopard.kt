...
class ArSnowleopard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoNode = VideoNode(sceneView.engine, scaleToUnits = 0.7f, centerOrigin = Position(y=-4f), glbFileLocation = "snowleopard.glb", player = mediaPlayer, onLoaded = {_,_ ->
            mediaPlayer.start()
        })
